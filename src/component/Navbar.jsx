...
import { Modal } from "../component/modal/Modal"; // Pastikan path sesuai
      ...
      <div className="container max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        ...
        >
          ...
          <button
            ...
            className="block py-2 px-8 text-gray-700 font-medium hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          >
            Join Us
          </button>
          <Modal isOpen={isRegisterOpen} onClose={toggleRegisterForm}>
